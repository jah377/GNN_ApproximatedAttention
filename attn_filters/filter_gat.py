...
def gat_filter(data, args):
    ...
    train_loader = NeighborLoader(
        ...
        num_neighbors=[args.GAT_NEIGHBORS]*args.GAT_LAYERS,
        shuffle=True,
    ...
    subgraph_loader = NeighborLoader(
        copy.copy(data),
        input_nodes=None,
        num_neighbors=[-1]*args.GAT_LAYERS,  # sample all neighbors
    ...
    for _ in range(1, args.GAT_EPOCHS+1):
